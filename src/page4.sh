...
freeview \
    -v "${mri_dir}"/nu.mgz \
    -v "${mri_dir}"/lh.hippoAmygLabels-T1.v22.FSvoxelSpace.mgz:visible=1:colormap=lut \
...
freeview \
    -v "${mri_dir}"/nu.mgz \
    -v "${mri_dir}"/rh.hippoAmygLabels-T1.v22.FSvoxelSpace.mgz:visible=1:colormap=lut \
    -viewsize 400 400 --layout 1 --zoom 2.5 --viewport sag \
    -ras ${RASR} \
...
freeview \
    -v "${mri_dir}"/nu.mgz \
    -v "${mri_dir}"/brainstemSsLabels.v13.FSvoxelSpace.mgz:visible=1:colormap=lut \
